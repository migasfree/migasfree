...
class Version(models.Model):
    ...
    computerbase = models.CharField(
        unicode(_("Computer base")),
        max_length=50,
        help_text=unicode(_("Name of computer with the software base")),
        default="---"
    )

    base = models.TextField(
        unicode(_("software base")),
        null=False,
        blank=True,
        help_text=unicode(_("List ordered of packages base for this version"))
    )
