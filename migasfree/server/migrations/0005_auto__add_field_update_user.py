...
from migasfree.server.models import User

class Migration(SchemaMigration):

    def forwards(self, orm):

        User(id=0,name="Unkown").save()

        # Adding field 'Update.user'
        db.add_column('server_update', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['server.User']), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Update.user'
        db.delete_column('server_update', 'user_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 1, 21, 26, 52, 987998)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 1, 21, 26, 52, 987896)'}),
