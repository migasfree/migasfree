...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repository.defaultpreinclude'
        db.add_column('server_repository', 'defaultpreinclude',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repository.defaultpreinclude'
        db.delete_column('server_repository', 'defaultpreinclude')
