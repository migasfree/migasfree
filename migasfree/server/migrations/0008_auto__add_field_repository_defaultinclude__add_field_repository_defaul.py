...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repository.defaultinclude'
        db.add_column('server_repository', 'defaultinclude',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.defaultexclude'
        db.add_column('server_repository', 'defaultexclude',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repository.defaultinclude'
        db.delete_column('server_repository', 'defaultinclude')

        # Deleting field 'Repository.defaultexclude'
        db.delete_column('server_repository', 'defaultexclude')
