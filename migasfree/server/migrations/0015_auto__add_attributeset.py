...
def rename_property_all_systems():
    cursor = connection.cursor()
    try:
        #delete login registers
        cursor.execute("UPDATE  server_property SET prefix='SET',name='ATTRIBUTES SET' where id = 1;")
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        rename_property_all_systems()

        # Adding model 'AttributeSet'
        db.create_table(u'server_attributeset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('server', ['AttributeSet'])

        # Adding M2M table for field attributes on 'AttributeSet'
        db.create_table(u'server_attributeset_attributes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('attributeset', models.ForeignKey(orm['server.attributeset'], null=False)),
            ('attribute', models.ForeignKey(orm['server.attribute'], null=False))
        ))
        db.create_unique(u'server_attributeset_attributes', ['attributeset_id', 'attribute_id'])

        # Adding M2M table for field excludes on 'AttributeSet'
        db.create_table(u'server_attributeset_excludes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('attributeset', models.ForeignKey(orm['server.attributeset'], null=False)),
            ('attribute', models.ForeignKey(orm['server.attribute'], null=False))
        ))
        db.create_unique(u'server_attributeset_excludes', ['attributeset_id', 'attribute_id'])

    def backwards(self, orm):
        # Deleting model 'AttributeSet'
        db.delete_table(u'server_attributeset')

        # Removing M2M table for field attributes on 'AttributeSet'
        db.delete_table('server_attributeset_attributes')

        # Removing M2M table for field excludes on 'AttributeSet'
        db.delete_table('server_attributeset_excludes')
    ...
    models = {
        ...
        'server.attributeset': {
            ...
            'excludes': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'ExcludeAttributeGroup'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['server.Attribute']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
