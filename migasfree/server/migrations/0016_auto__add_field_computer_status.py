...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Computer.status'
        db.add_column(u'server_computer', 'status',
                      self.gf('django.db.models.fields.CharField')(default='intended', max_length=20),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Computer.status'
        db.delete_column(u'server_computer', 'status')
