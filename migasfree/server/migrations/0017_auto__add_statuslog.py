...
from migasfree.server.models import Computer, StatusLog
...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'server_statuslog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('computer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['server.Computer'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='intended', max_length=20)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('server', ['StatusLog'])

        insert_status_log_initial()

    def backwards(self, orm):
        # Deleting model 'StatusLog'
        db.delete_table(u'server_statuslog')
    ...
    models = {
        ...
        'server.computer': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'intended'", 'max_length': '20'}),
