...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('server_login', ['computer_id'])


    def backwards(self, orm):

        # Removing unique constraint on 'Login', fields ['computer']
        db.delete_unique('server_login', ['computer_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 23, 12, 11, 4, 411756)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 23, 12, 11, 4, 411631)'}),
