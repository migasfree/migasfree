...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Computer.uuid'
        db.add_column('server_computer', 'uuid',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('server_computer', 'uuid')
    ...
    models = {
        ...
        'server.computer': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '36', 'null': 'True', 'blank': 'True'}),
